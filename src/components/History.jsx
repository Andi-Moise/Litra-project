...
export default function History() {
  return (
    ...
    <img src={SliderI} alt="" className='absolute h-full w-full -right-[600px] z-10'/>
      <div className="leaf w-full h-full  flex absolute -left-[500px] bg-black opacity-90 z-0 flex">
      ...
      <div className='aux z-50'>
        ...
        <div className="part z-50">
            ...
            <p>95% din berile noastre sunt fabricate conform legii purității berii bavareze. Noi nu folosim conservanți, arome sau orice fel de aditivi, berea este nefiltrată și nepateurizată astfel, fiind - 100% naturală.</p>
        </div>
      </div>

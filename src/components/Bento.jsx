       ...
       <img src={Layer_3} alt="" className='img2 absolute bottom-0 -left-[100px] h-[700px] z-10'/>
        <div className="container h-full  ">
            ...
            <div className="grid-bento w-full pb-3 z-30">
                <div className="part1"><img src="https://scontent.fkiv9-2.fna.fbcdn.net/v/t39.30808-6/320250366_2149804185191805_8568516274810662706_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=86c6b0&_nc_ohc=7FYBjKyeb8wQ7kNvgHyKqaY&_nc_zt=23&_nc_ht=scontent.fkiv9-2.fna&_nc_gid=Ayz_p84r4scackfdJc4dgkP&oh=00_AYAkJ63mH3E1K8nXO0ZRkBpNiuNi3tYQe40qQaM9t1NGAA&oe=676B1B08" alt="" /></div>

...
export default function Bento() {
  return (
    <div className='bento h-screen w-full relative  my-4'>
       <img src={Layer_2} alt="" className='absolute top-0 -right-[100px] h-[900px] -z-10'/>
        <div className="container h-full z-0">
            <div className='text'>
                <p className="title">Our</p>
                <p className="title">Hospitality</p>
            </div>
            
            <div className="grid-bento w-full">
